...
class GenerationValuesSchema(pa.SchemaModel):
    ...
    power_kw: pa.typing.Series[pa.dtypes.Float] = pa.Field(
        ge=0, description="The power generated by the site in kw over the given time period."
    )
...
def insert_generation_values(
    ...
    for site_uuid in site_uuids:
        ...
        for start_datetime in start_datetimes:
            ...
            df_target_entries: pd.DataFrame = df_site.loc[df_site["start_utc"] == start_datetimes]
